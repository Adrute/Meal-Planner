...
export const CATEGORY_COLORS: Record<string, string> = {
  ...
  Ocio:                  'bg-lime-100 text-lime-700',
  Ropa:                  'bg-teal-100 text-teal-600',
  Educación:             'bg-emerald-100 text-emerald-600',
  Suscripciones:         'bg-green-100 text-green-700',
  'Impuestos y seguros': 'bg-lime-100 text-lime-800',
  Regalos:               'bg-teal-100 text-teal-700',
  Ahorro:                'bg-green-100 text-green-700',
  Inversiones:           'bg-emerald-100 text-emerald-700',
  Deudas:                'bg-lime-100 text-lime-800',
